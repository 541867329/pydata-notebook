...
DC_PATH = "/home/yjhl/PycharmProjects/pydata-notebook/mydemo/randomData/districtcode.txt"
...
def gennerator():
    ...
    if not codelist:
        getdistrictcode()
    region = codelist[random.randint(0, len(codelist)-1)]
    #error 获取state存在问题
    # print(region['state'] + ' ' + region['city'] + ' ' + region['district'])
    id = region['code']  # 地区项
    ...
    #        1   5   0  4  0  4  1  9  3  9  0  3  0   1  1  9  5 5
    checkcode = {'0': '1',
                 '1': '0',
                 '2': 'X',
                 '3': '9',
...
# 生成随机的名字
def full_name():
    lns = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨', '朱', '秦', '尤', '许',
           ...
           '熊', '纪', '舒', '屈', '项', '祝', '董', '梁']
    fns = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
...
def getData():
    ...
    if int(id[-2])%2 == 0:
        ...
        sex =1
    return (id,name,phone,birthday,address,sex)